...
class AddLugarFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        imagenUtiles = ImagenUtiles(requireContext(),binding.btPhoto,
        binding.btRotaL,binding.btRotaR,binding.imagen,tomarFotoActivity)
    ...
    private fun subeAudioNube() {
        ...
        if (audioFile.exists() && audioFile.isFile && audioFile.canRead()){
            ...
            val rutaNube = "lugaresApp/${Firebase.auth.currentUser?.email}/audio/${audioFile.name}"
            val referencia: StorageReference = Firebase.storage.reference
                .child(rutaNube)
    ...
    private fun subeImagenNube(rutaAudio: String) {
        ...
        if (imagenFile.exists() && imagenFile.isFile && imagenFile.canRead()){
            ...
            val rutaNube = "lugaresApp/${Firebase.auth.currentUser?.email}/imagen/${imagenFile.name}"
